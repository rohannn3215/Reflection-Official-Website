...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  const setupLenis = useCallback(() => {
    ...
    const lenis = new Lenis({
      lerp: 0.03, // Ultra-smooth
      smoothWheel: true,
      wheelMultiplier: 0.5, // Even gentler
      infinite: false,
  ...
  return (
    ...
    >
      <div className="scroll-stack-inner pt-[20vh] px-20 pb-[2vh]"> {/* further reduced bottom padding for clean transition */}
        {children}
      </div>
    </div>
  );
